...
export const renderInverterElements = (
	...
	// Khung Inverter (W/A): inverterColour riêng, grey khi Standby HOẶC khi
	// công suất Inverter hiện tại (displayInverterPower) = 0. Dùng ngưỡng
	// nhỏ (<1W) thay vì so sánh chặt !==0 -- sensor có thể trả về sai số
	// thập phân cực nhỏ thay vì đúng số 0 tuyệt đối.
